...
import org.justin.condiment.thecondimentmod.entity.animations.ModAnimationDefinitions;
...
public class TheMayoMonsterModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(ModAnimationDefinitions.WALK,limbSwing,limbSwingAmount,0F,0F);
		this.animate(((MayoMonsterEntity)entity).idleAnimationState,ModAnimationDefinitions.IDLE,ageInTicks,1f);
		//this.animate(((MayoMonsterEntity) entity).attackAnimationState, ModAnimationDefinitions.JAW_MOVES, ageInTicks, 1f);
	}
	/*
