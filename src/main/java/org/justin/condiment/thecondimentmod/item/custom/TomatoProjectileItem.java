package org.justin.condiment.thecondimentmod.item.custom;
...
public class TomatoProjectileItem extends Item {
    public TomatoProjectileItem(Properties p_41383_) {
        super(p_41383_);
    }
    public InteractionResultHolder<ItemStack> use(Level p_43142_, Player p_43143_, InteractionHand p_43144_) {
        ...
        if (!p_43142_.isClientSide) {
            TomatoProjectileEntity tomatoProjectileEntity = new TomatoProjectileEntity(p_43142_, p_43143_);
            tomatoProjectileEntity.setItem(itemstack);
            tomatoProjectileEntity.shootFromRotation(p_43143_, p_43143_.getXRot(), p_43143_.getYRot(), 0.0F, 1.5F, 1.0F);
            p_43142_.addFreshEntity(tomatoProjectileEntity);
        }
